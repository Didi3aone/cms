    ...
    <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
            <div class="single_page">
                ...
                <?php 
                    $id         = $artikel_single['artikel_id'];
                    $judul      = $artikel_single['artikel_judul'];
                    $seo        = $artikel_single['artikel_pretty_url'];
                    $isi        = $artikel_single['artikel_isi'];
                    $created_by = $artikel_single['create_by'];
                    $date       = $artikel_single['artikel_created_date'];
                    $photo      = $artikel_single['artikel_photo'];
                    $photo_real = $artikel_single['artikel_photo_real'];
                    $kategori   = $artikel_single['kategori'];
                ?>
                <h1><?= $judul; ?></h1>
