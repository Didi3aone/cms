    ...
    <aside id="left-panel">
        ...
        <div class="login-info">
            <span> <!-- User image size is adjusted inside CSS, it should stay as it --> 
                <a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
                    <!-- <img src="<?php// base_url() ?>asset/img/avatars/sunny.png" alt="me" class="online" />  -->
                    <span>
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="#"><i class="fa fa-lg fa-fw fa-bar-chart-o"></i> <span class="menu-item-parent">Article</span></a>
                    <ul>
                        <li class="<?= (isset($active_page) && $active_page == "artikel-list") ? "active" : "" ?>">
                            <a href="<?= site_url() ?>manager/article ">List New Article</a>
                        </li>

                        <li class="<?= (isset($active_page) && $active_page == "artikel-publish") ? "active" : "" ?>">
                            <a href="<?= site_url() ?>manager/article/list ">List Publish Article</a>
                        </li>

                        <li class="<?= (isset($active_page) && $active_page == "artikel-create") ? "active" : ""?>">
                            <a href="<?= site_url() ?>manager/article/create">Create Article</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-lg fa-fw fa-youtube-square"></i> <span class="menu-item-parent">Article Video</span></a>
                    <ul>
                        <li class="<?= (isset($active_page) && $active_page == "artikel-video") ? "active" : "" ?>">
                            <a href="<?= site_url() ?>manager/article-video ">List Data</a>
                        </li>
                        <li class="<?= (isset($active_page) && $active_page == "artikel-video-create") ? "active" : "" ?>">
                            <a href="<?= site_url() ?>manager/article-video/create">Create Article</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul>
                        <li class="<?= (isset($active_page) && $active_page == "tag-list") ? "active" : ""?>">
                            <a href="<?= site_url('manager/tag') ?>">List Data</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-lg fa-fw fa-calendar"></i> <span class="menu-item-parent">Jadwal</span></a>
                    <ul>
                        <li class="<?= (isset($active_page) && $active_page == "jadwal") ? "active" : ""?>">
                            <a href="<?= site_url('manager/jadwal') ?>">List Data</a>
                        </li>
                        <li class="<?= (isset($active_page) && $active_page == "jadwal-create") ? "active" : ""?>">
                            <a href="<?= site_url('manager/jadwal/create') ?>">Create Jadwal</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-lg fa-fw fa-book"></i> <span class="menu-item-parent">Category</span></a>
                    <ul>
                        <li class="<?= (isset($active_page) && $active_page == "category") ? "active" : ""?>">
                            <a href="<?= site_url('manager/category') ?>">List Data</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        <li class="<?= (isset($active_page) && $active_page == "setting") ? "active" : ""?>">
                            <a href="<?= site_url('manager/setting') ?>">Setting</a>
                        </li>
                    </ul>
                </li>
            </ul>
