						...
						<div class="widget-body no-padding">
							...
							<form id="form" class="smart-form" method="POST" action="<?php echo site_url('admin/article/process_form') ?>">
								...
								<fieldset>
									...
									<div class="row">
										<section class="col col-6">
											<label class="input">Tag Artikel</label>
												<textarea cols="58"><?= "#" .$tag ?></textarea>
										</section>
		                            ...
		                            <div class="row">
										<section class="col col-lg-12">
											<label class="textarea"> Content										
												<textarea rows="20" name="artikel_isi" disabled="disabled"><?= strip_tags($content) ?></textarea> 
											</label>
										</section>
									</div>
									...
									<footer>
										<?php 
											...
											if( $role == 1 || $role == 2 ):
										?>
											<a href="" data-name="<?= $Judul ?>" data-id="<?= $id ?>" class="btn btn-primary publish"> <i class="fa fa-upload"></i>
												Publish Artikel</a>
										<?php endif;?>
										<a href="<?= site_url() ?>manager/article" class="btn btn-danger"><i class="fa fa-arrow-left"></i> back</a>
									</footer>
								</fieldset>
							</form>
						</div>
