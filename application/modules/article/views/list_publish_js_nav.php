<script type="text/javascript">
	...
	var lists = function () {
	    ...
	    var ajax_source = "<?= site_url('manager/article/list_all_datas'); ?>";
	    ...
	    var columns = [
	        ...
	        //                      ' <a href="'+ url +'delete" data-id ="' + full.artikel_id + '" data-name ="' + full.group_name + '" class="btn btn-danger btn-circle delete-confirm" rel="tooltip" title="Delete Group" data-placement="top" ><i class="fa fa-trash-o"></i></a>';
	        //             edit +=  '</td>';
