...
<div id="content">
    <div class="row">
        ...
        <!-- <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 col-lg-offset-1 text-right">
            <h1>
                <a class="btn btn-primary" href="<?php //site_url(); ?>manager/article/create" rel="tooltip" title="Add new Group" data-placement="left">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hasinput">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="name_filter" name="filter[name]" class="form-control filter-this" placeholder="Judul" />
                                                    <div class="input-group-btn"><button type="button" class="clear-filter btn"><i class="fa fa-close"></i></button></div>
                                                </div>
                                            </div>
                                        </th>
                                       ...
                                       <!--  <th class="hasinput">
                                        ...
                                        <th class="hasinput">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="last_login_filter" name="filter[created]" class="form-control filter-this date-range-picker" placeholder="Article Create Date" readonly />
                                    ...
                                    <tr>
                                        <th data-hide="phone,tablet">Artikel ID</th>
                                        <th data-class="expand"> Artikel Judul</th>
                                        <th data-hide="phone"> Artikel Created Date</th>
                                        <th data-hide="phone"> Penulis</th>
