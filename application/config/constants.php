...
define("ARTIKEL_AKHLAQ_AS_SUNNAH", 45);
define("ARTIKEL_AMALAN_AS_SUNNAH", 46);
define("ARTIKEL_JALAN_KEBENARAN_AS_SUNNAH", 47);
define("ARTIKEL_KELUARGA_AS_SUNNAH", 48);
define("JADWAL_KATEGORI_KAJIAN_AKHWAT", 146);
define("JADWAL_KATEGORI_KAJIAN_UMUM", 145);
define("JADWAL_KATEGORI_KAJIAN_IKHWAN", 147);
define("KHUTBAH_JUMAT", 49);
	// define("ARTIKEL_KATEGORI_MANHAJ", 91);
	// define("ARTIKEL_KATEGORI_AQIDAH", 92);
define("KAJIAN", 2);
define("TIPS", 1);
