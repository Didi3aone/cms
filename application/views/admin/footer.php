...
<!-- PAGE FOOTER -->
    ...
    <!-- END PAGE FOOTER --> 
        <div id="shortcut">
            <ul>
                <li>
                    <a href="<?= site_url('admin/user/change_password') ?>" class="jarvismetro-tile big-cubes bg-color-greenLight"> <span class="iconbox"> <i class="fa fa-key fa-4x"></i> <span>Change Password </span> </span> </a>
                </li>
                <li>
                    <a href="<?= site_url('admin/user/profile') ?>" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>Change Profile </span> </span> </a>
                </li>
            </ul>
        </div>
        <!-- END SHORTCUT AREA -->
